<p align="center">
  <img src="./build/icon.png" alt="Nexus" width="128" />
</p>
...
Nexus управляет жизненным циклом двух сетевых сервисов из одного UI:
...
<p align="center">
  <img src="./docs/preview.png" alt="Nexus — превью" width="720" />
</p>
...
В dev-режиме используется отдельная папка `%APPDATA%\nexus-dev`,
...
| Файл | Назначение |
| --- | --- |
| `dist\Nexus_x64.exe` | NSIS-инсталлятор (perMachine, требует админ-прав) |
| `dist\Nexus_x64-portable.7z` | Портативный архив (распакуй и запускай) |
...
Nexus распространяется под лицензией **GNU General Public License
...
от которых наследуется Nexus (см. ниже).

## Авторство и сторонние компоненты

Nexus стоит на плечах нескольких open-source проектов. Полный
...
Разработка и поддержка — **whymeow**.
